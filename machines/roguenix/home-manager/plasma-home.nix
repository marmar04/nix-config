{
  programs.plasma = {
    ...
    configFile = {
      ...
      "dolphinrc"."Open-with settings"."History" = "jop";
      "dolphinrc"."Search"."Location" = "Everywhere";
      "kactivitymanagerdrc"."activities"."813754b3-6b11-4d8a-9021-6113ec1e139e" = "Default";
      "kactivitymanagerdrc"."main"."currentActivity" = "813754b3-6b11-4d8a-9021-6113ec1e139e";
      "kcminputrc"."Keyboard"."NumLock" = 0;
      "kcminputrc"."Libinput.1118.1957.Microsoft Microsoft® 2.4GHz Transceiver v9.0 Mouse"."NaturalScroll" = true;
      "kcminputrc"."Libinput.1118.1957.Microsoft Microsoft® 2.4GHz Transceiver v9.0 Mouse"."PointerAcceleration" = 1.000;
      "kcminputrc"."Libinput.1121.19735.USB Optical Mouse"."NaturalScroll" = true;
      "kcminputrc"."Libinput.1121.19735.USB Optical Mouse"."PointerAcceleration" = 1.000;
      "kcminputrc"."Libinput.2362.597.UNIW0001:00 093A:0255 Mouse"."NaturalScroll" = true;
      ...
      "kcminputrc"."Libinput.2362.597.UNIW0001:00 093A:0255 Touchpad"."PointerAcceleration" = 1.000;
      "kcminputrc"."Libinput.2362.597.UNIW0001:00 093A:0255 Touchpad"."TapToClick" = true;
      "kcminputrc"."Libinput.7247.52.SIGMACHIP Usb Mouse"."NaturalScroll" = true;
      "kcminputrc"."Libinput.7247.52.SIGMACHIP Usb Mouse"."PointerAcceleration" = 1.000;
      "kcminputrc"."Libinput.9354.34068.Telink Wireless Receiver Mouse"."NaturalScroll" = true;
      "kcminputrc"."Libinput.9354.34068.Telink Wireless Receiver Mouse"."PointerAcceleration" = 1.000;
      ...
      "kded5rc"."Module-plasma_accentcolor_service"."autoload" = false;
      ...
      "kdeglobals"."General"."AccentColor" = "166,227,161";
      "kdeglobals"."General"."BrowserApplication" = "firefox.desktop";
      "kdeglobals"."General"."LastUsedCustomAccentColor" = "166,227,161";
      "kdeglobals"."General"."XftHintStyle" = "hintslight";
      "kdeglobals"."General"."XftSubPixel" = "none";
      "kdeglobals"."General"."fixed" = "JetBrains Mono,10,-1,5,50,0,0,0,0,0";
      ...
      "khotkeysrc"."Data_2_1Triggers0"."Uuid" = "{bac53021-0656-42dc-9729-9951c8385828}";
      ...
      "khotkeysrc"."Data_2_2Triggers0"."Uuid" = "{ca6e7442-bd80-4b63-ae7e-ed3d3723912f}";
      ...
      "khotkeysrc"."Data_2_3Triggers0"."Uuid" = "{842ab4c2-740b-4df5-a0ee-d2b119fd0673}";
      ...
      "khotkeysrc"."Data_2_4Triggers0"."Uuid" = "{115580fe-efdc-4ca0-a60b-d51c434f8376}";
      ...
      "khotkeysrc"."Data_2_5Triggers0"."Uuid" = "{d787dc8a-4606-4f05-b359-405ec7e73fcb}";
      ...
      "khotkeysrc"."Data_2_6Triggers0"."Uuid" = "{ad320568-e5bb-460d-b039-fc0da37d4a80}";
      ...
      "khotkeysrc"."Data_2_8Triggers0"."Uuid" = "{154bbaf5-949d-4c88-a618-39d5f2be9623}";
      ...
      "kscreenlockerrc"."Greeter.Wallpaper.org.kde.image.General"."Image" = "/home/marmar/.config/wallpaper/lockscreen.png";
      "kscreenlockerrc"."Greeter.Wallpaper.org.kde.image.General"."PreviewImage" = "/home/marmar/.config/wallpaper/lockscreen.png";
      ...
      "kwinrc"."Desktops"."Id_1" = "b7648024-e810-4142-8df3-0c99e7f06de6";
      "kwinrc"."Desktops"."Id_2" = "a5353432-fe0c-4735-838a-69c34382d656";
      "kwinrc"."Desktops"."Id_3" = "72021064-db6c-4f86-b78d-419f92eb0574";
      "kwinrc"."Desktops"."Id_4" = "bc91324c-f41a-416e-8806-2e418cc557a5";
      "kwinrc"."Desktops"."Id_5" = "49dd2d36-24fd-40fd-898b-3e7d45a52067";
      "kwinrc"."Desktops"."Id_6" = "86597c6b-3744-4da0-adf7-6e1752125074";
      "kwinrc"."Desktops"."Id_7" = "486004f6-2497-459c-a77a-1916202721b6";
      "kwinrc"."Desktops"."Number" = 7;
      "kwinrc"."Desktops"."Rows" = 1;
      "kwinrc"."NightColor"."Active" = true;
      "kwinrc"."NightColor"."LatitudeAuto" = 3.07;
      "kwinrc"."NightColor"."LongitudeAuto" = 101.62;
      "kwinrc"."Plugins"."screenedgeEnabled" = false;
      "kwinrc"."Script-bismuth"."ignoreTitle" = "Picture in picture";
      ...
      "kwinrc"."Tiling.0185d0e4-7921-5ff6-ad6d-b4191606d894"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling.13805356-d71e-5156-903e-64a64bfc5aae"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      ...
      "kwinrulesrc"."1"."Description" = "Window settings for calibre-ebook-viewer";
      ...
      "kwinrulesrc"."1"."title" = "How to Win Friends and Influence People [EPUB] — E-book viewer";
      "kwinrulesrc"."1"."types" = 1;
      "kwinrulesrc"."1"."wmclass" = "python3.11 calibre-ebook-viewer";
      "kwinrulesrc"."1"."wmclasscomplete" = true;
      "kwinrulesrc"."1"."wmclassmatch" = 1;
      "kwinrulesrc"."1b8549fd-4bde-41f5-8aad-3505278c17f0"."Description" = "Application settings for org.kde.arianna";
      "kwinrulesrc"."1b8549fd-4bde-41f5-8aad-3505278c17f0"."maximizehoriz" = true;
      "kwinrulesrc"."1b8549fd-4bde-41f5-8aad-3505278c17f0"."maximizehorizrule" = 3;
      "kwinrulesrc"."1b8549fd-4bde-41f5-8aad-3505278c17f0"."maximizevert" = true;
      "kwinrulesrc"."1b8549fd-4bde-41f5-8aad-3505278c17f0"."maximizevertrule" = 3;
      "kwinrulesrc"."1b8549fd-4bde-41f5-8aad-3505278c17f0"."wmclass" = "arianna org.kde.arianna";
      "kwinrulesrc"."1b8549fd-4bde-41f5-8aad-3505278c17f0"."wmclasscomplete" = true;
      "kwinrulesrc"."1b8549fd-4bde-41f5-8aad-3505278c17f0"."wmclassmatch" = 1;
      "kwinrulesrc"."1d244d3e-efbd-48a6-ba56-4439cb8b78a1"."Description" = "Window settings for calibre-ebook-viewer";
      "kwinrulesrc"."1d244d3e-efbd-48a6-ba56-4439cb8b78a1"."maximizehoriz" = true;
      "kwinrulesrc"."1d244d3e-efbd-48a6-ba56-4439cb8b78a1"."maximizehorizrule" = 3;
      "kwinrulesrc"."1d244d3e-efbd-48a6-ba56-4439cb8b78a1"."maximizevert" = true;
      "kwinrulesrc"."1d244d3e-efbd-48a6-ba56-4439cb8b78a1"."maximizevertrule" = 3;
      "kwinrulesrc"."1d244d3e-efbd-48a6-ba56-4439cb8b78a1"."title" = "How to Win Friends and Influence People [EPUB] — E-book viewer";
      "kwinrulesrc"."1d244d3e-efbd-48a6-ba56-4439cb8b78a1"."types" = 1;
      "kwinrulesrc"."1d244d3e-efbd-48a6-ba56-4439cb8b78a1"."wmclass" = "python3.10 calibre-ebook-viewer";
      "kwinrulesrc"."1d244d3e-efbd-48a6-ba56-4439cb8b78a1"."wmclasscomplete" = true;
      "kwinrulesrc"."1d244d3e-efbd-48a6-ba56-4439cb8b78a1"."wmclassmatch" = 1;
      "kwinrulesrc"."2"."Description" = "Application settings for org.kde.arianna";
      ...
      "kwinrulesrc"."2"."title" = "How to Win Friends and Influence People [EPUB] — E-book viewer";
      "kwinrulesrc"."2"."wmclass" = "arianna org.kde.arianna";
      "kwinrulesrc"."2"."wmclasscomplete" = true;
      "kwinrulesrc"."2"."wmclassmatch" = 1;
      "kwinrulesrc"."3"."Description" = "Window settings for calibre-ebook-viewer";
      ...
      "kwinrulesrc"."3"."maximizevertrule" = 3;
      "kwinrulesrc"."3"."title" = "How to Win Friends and Influence People [EPUB] — E-book viewer";
      "kwinrulesrc"."3"."types" = 1;
      "kwinrulesrc"."3"."wmclass" = "python3.10 calibre-ebook-viewer";
      "kwinrulesrc"."3"."wmclasscomplete" = true;
      "kwinrulesrc"."3"."wmclassmatch" = 1;
      "kwinrulesrc"."4"."Description" = "Picture-in-Picture";
      ...
      "kwinrulesrc"."4"."title" = "Picture-in-Picture";
      "kwinrulesrc"."4"."titlematch" = 1;
      "kwinrulesrc"."4"."wmclass" = "firefox firefox";
      "kwinrulesrc"."4"."wmclasscomplete" = true;
      "kwinrulesrc"."4"."wmclassmatch" = 1;
      "kwinrulesrc"."484b9324-a84e-493d-871b-82afc45abca0"."Description" = "Application settings for org.kde.konversation";
      "kwinrulesrc"."484b9324-a84e-493d-871b-82afc45abca0"."desktops" = "72021064-db6c-4f86-b78d-419f92eb0574";
      "kwinrulesrc"."484b9324-a84e-493d-871b-82afc45abca0"."desktopsrule" = 3;
      "kwinrulesrc"."484b9324-a84e-493d-871b-82afc45abca0"."maximizevert" = true;
      "kwinrulesrc"."484b9324-a84e-493d-871b-82afc45abca0"."maximizevertrule" = 3;
      "kwinrulesrc"."484b9324-a84e-493d-871b-82afc45abca0"."placement" = 4;
      "kwinrulesrc"."484b9324-a84e-493d-871b-82afc45abca0"."placementrule" = 2;
      "kwinrulesrc"."484b9324-a84e-493d-871b-82afc45abca0"."wmclass" = "konversation org.kde.konversation";
      "kwinrulesrc"."484b9324-a84e-493d-871b-82afc45abca0"."wmclasscomplete" = true;
      "kwinrulesrc"."484b9324-a84e-493d-871b-82afc45abca0"."wmclassmatch" = 1;
      "kwinrulesrc"."5"."Description" = "Picture-in-Picture";
      "kwinrulesrc"."5"."above" = true;
      "kwinrulesrc"."5"."aboverule" = 2;
      "kwinrulesrc"."5"."desktops" = "\\0";
      "kwinrulesrc"."5"."desktopsrule" = 2;
      "kwinrulesrc"."5"."title" = "Picture-in-Picture";
      "kwinrulesrc"."5"."titlematch" = 1;
      "kwinrulesrc"."5"."wmclass" = "firefox firefox";
      ...
      "kwinrulesrc"."cc558724-aa56-43d0-9ae3-453ad70381cc"."Description" = "Window settings for calibre-ebook-viewer";
      "kwinrulesrc"."cc558724-aa56-43d0-9ae3-453ad70381cc"."maximizehoriz" = true;
      "kwinrulesrc"."cc558724-aa56-43d0-9ae3-453ad70381cc"."maximizehorizrule" = 3;
      "kwinrulesrc"."cc558724-aa56-43d0-9ae3-453ad70381cc"."maximizevert" = true;
      "kwinrulesrc"."cc558724-aa56-43d0-9ae3-453ad70381cc"."maximizevertrule" = 3;
      "kwinrulesrc"."cc558724-aa56-43d0-9ae3-453ad70381cc"."title" = "How to Win Friends and Influence People [EPUB] — E-book viewer";
      "kwinrulesrc"."cc558724-aa56-43d0-9ae3-453ad70381cc"."types" = 1;
      "kwinrulesrc"."cc558724-aa56-43d0-9ae3-453ad70381cc"."wmclass" = "python3.11 calibre-ebook-viewer";
      "kwinrulesrc"."cc558724-aa56-43d0-9ae3-453ad70381cc"."wmclasscomplete" = true;
      "kwinrulesrc"."cc558724-aa56-43d0-9ae3-453ad70381cc"."wmclassmatch" = 1;
      "kwinrulesrc"."dd92e1c2-0ede-48ad-b465-57b09cdb49e5"."Description" = "Window settings for nheko";
      "kwinrulesrc"."dd92e1c2-0ede-48ad-b465-57b09cdb49e5"."desktops" = "72021064-db6c-4f86-b78d-419f92eb0574";
      "kwinrulesrc"."dd92e1c2-0ede-48ad-b465-57b09cdb49e5"."desktopsrule" = 3;
      "kwinrulesrc"."dd92e1c2-0ede-48ad-b465-57b09cdb49e5"."maximizevert" = true;
      "kwinrulesrc"."dd92e1c2-0ede-48ad-b465-57b09cdb49e5"."maximizevertrule" = 3;
      "kwinrulesrc"."dd92e1c2-0ede-48ad-b465-57b09cdb49e5"."title" = "nheko";
      "kwinrulesrc"."dd92e1c2-0ede-48ad-b465-57b09cdb49e5"."titlematch" = 1;
      "kwinrulesrc"."dd92e1c2-0ede-48ad-b465-57b09cdb49e5"."types" = 1;
      "kwinrulesrc"."dd92e1c2-0ede-48ad-b465-57b09cdb49e5"."wmclass" = "nheko";
      "kwinrulesrc"."dd92e1c2-0ede-48ad-b465-57b09cdb49e5"."wmclassmatch" = 1;
      "kwinrulesrc"."eb5e0d21-2b37-4cf5-ac49-6eb6e1f6f683"."Description" = "Picture-in-Picture";
      "kwinrulesrc"."eb5e0d21-2b37-4cf5-ac49-6eb6e1f6f683"."above" = true;
      "kwinrulesrc"."eb5e0d21-2b37-4cf5-ac49-6eb6e1f6f683"."aboverule" = 2;
      "kwinrulesrc"."eb5e0d21-2b37-4cf5-ac49-6eb6e1f6f683"."desktops" = "\\0";
      "kwinrulesrc"."eb5e0d21-2b37-4cf5-ac49-6eb6e1f6f683"."desktopsrule" = 2;
      "kwinrulesrc"."eb5e0d21-2b37-4cf5-ac49-6eb6e1f6f683"."title" = "Picture-in-Picture";
      "kwinrulesrc"."eb5e0d21-2b37-4cf5-ac49-6eb6e1f6f683"."titlematch" = 1;
      "kwinrulesrc"."eb5e0d21-2b37-4cf5-ac49-6eb6e1f6f683"."wmclass" = "firefox firefox";
